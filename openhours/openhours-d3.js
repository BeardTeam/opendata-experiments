var nameFileWithPathWithoutExtension = "openhours/divertimento_e_ristoro_-_openhours";
...
$(function() {
	...
	find_open_places(csvFile, new Date(), function(openSpots) {
		render(openSpots);
	});
});
...
d3methods.dragmove = function(d) {
  ...
  find_open_places(csvFile, today, function(openSpots) {
    redraw(openSpots);
  });
};
